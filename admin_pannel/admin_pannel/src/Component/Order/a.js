  ...
  return (
    <div className="content-body">
      <div className="filter-section">
        ...
        <button onClick={fetchOrders} className="btn btn-primary">Filter</button>
      </div>

      <div className="export-section">
        <CSVLink data={filterData()} filename="order_report.csv" className="btn btn-success">Export CSV</CSVLink>
        <button onClick={handlePDFDownload} className="btn btn-danger">Export PDF</button>
        <button onClick={handleXLSXDownload} className="btn btn-info">Export XLSX</button>
      </div>
                    ...
                    <tbody>
                      {data.map((order) => (
                        <tr key={order._id}>
                          ...
                          <td>
                            <button onClick={() => deletedata(order._id)} className="btn btn-link p-0 text-danger border-0">
